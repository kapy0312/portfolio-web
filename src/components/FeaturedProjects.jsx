...
const FEATURED = [
  {
    ...
    tags: ['SINUMERIK ONE', 'TIA Portal', 'C# / WinForms', 'SFTP / WinSCP', 'OPC-UA'],
    nda: true,
    github: null,
  ...
  },
  {
    ...
    tags: ['FastAPI', 'React', 'TimescaleDB', 'OPC-UA', 'SLMP', 'Isolation Forest', 'Ollama', 'Docker'],
    nda: false,
  ...
  },
  {
    ...
    tags: ['Electron', 'React', 'SQLite', 'Bitfinex API', 'Whop', 'GitHub Actions'],
    nda: false,
